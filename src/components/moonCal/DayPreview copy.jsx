...
export const DayPreview = (props) => {
    ...
    const loadDayPreview = () => {
        ...
        if (isToday()) {
            dayStyle.backgroundColor = 'midnightblue';
    ...
    const moonHour = () => {
        ...
        let hours = [];
        for (let i = 0; i < 23; i++) {
            if (sunrise < i && i < sunset) bgc = 'cyan';
            else if (i === sunrise || i === sunset) bgc = 'cyan';
            else if (i === sunrise -1 || i===sunset +1) bgc = 'darkcyan'
    ...
    const midHour = () => {
        ...
        for (let i = 0; i < 23; i++) {
            ...
            // if (i === sunrise || i === sunset) bgc = 'orange';
            // if (i === 12) bgc = 'orange';
            hours.push(<div className="mid-hour" key={i} style={{ backgroundColor: bgc }} />);
        }
        return hours;
    };
